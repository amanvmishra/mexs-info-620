            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="transaction.uid.label" default="Uid" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: transactionInstance, field: "uid")}</td>
